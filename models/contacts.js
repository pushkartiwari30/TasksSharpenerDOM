...
const getContactsFromFile = cb => {  // initilly there were 2 read files so we use this helper fn to make the reading code inot 1 function to make the code clean 
...
module.exports = class Contact {
    ...
    save() {
        ...
        getContactsFromFile(contacts =>{
            ...
            contacts.push(this); //mak sure to use arrow fn in the file read fn above or else the 'this' eyword will not point to the class
